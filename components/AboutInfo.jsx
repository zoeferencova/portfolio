...
const linkedInButton = <SmallButton text='LinkedIn' icon={linkedin} link='https://www.linkedin.com/in/zoeferencova/' extraClasses='inline-block mr-3' />
const githubButton = <SmallButton text='Github' icon={github} link='https://github.com/zoeferencova' extraClasses='inline-block' />
...
function AboutInfo() {
    ...
    return (
        <div className=''>
            <PageHeader title='About me' buttons={[linkedInButton, githubButton]} logo={logo} />
