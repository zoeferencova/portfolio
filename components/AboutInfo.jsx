...
const linkedInButton = <Button text='LinkedIn' icon={'/linkedin.svg'} link='https://www.linkedin.com/in/zoeferencova/' extraClasses='inline-block mr-3' />
const githubButton = <Button text='Github' icon={'/github.svg'} link='https://github.com/zoeferencova' extraClasses='inline-block' />


function AboutInfo({ page }) {
    const paragraphStyles = 'mb-4 mob:mb-5 text-base mob:text-md'

    return (
        <div className={`${page ? 'px-3' : 'p-6 mob:p-10'}`}>
